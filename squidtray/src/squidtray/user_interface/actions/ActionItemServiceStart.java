 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ActionItemServiceStart  implements ActionListener {
	private final JLabel statusLabel;
	
	public ActionItemServiceStart(final JLabel label) {
	...
	public void actionPerformed(ActionEvent evt) {
		int i;
		Services.Stop();
		statusLabel.setText("SquidTray is starting the SquidNT service");
